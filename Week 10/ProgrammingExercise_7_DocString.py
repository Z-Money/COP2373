import inspect
import ZachariahKersey_ProgrammingExercise_7  # replace with your assignment name (without .py)

# replace docstring_example with your assignment name in the next 2 lines of code
with open("ZachariahKersey_ProgrammingExercise_7.txt", "w") as doc:
    doc.write(f"# Technical Design Document: "
              f"{ZachariahKersey_ProgrammingExercise_7.__name__}\n\n")
    # replace with your name, the date, and the description of the program
    doc.write(f"# Name: Zachariah Kersey\n")
    doc.write(f"# Date: March 20, 2026\n")
    doc.write(f"# Program Description: Displays each sentence and number of "
              f"sentences within a paragraph\n\n")

    # replace docstring_example with your assignment name
    for name, func in inspect.getmembers(ZachariahKersey_ProgrammingExercise_7,
                                         inspect.isfunction):
